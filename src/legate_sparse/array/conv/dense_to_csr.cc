...
#include "legate_sparse/array/conv/dense_to_csr.h"
#include "legate_sparse/array/conv/dense_to_csr_template.inl"
...
/*static*/ void DenseToCSRNNZ::cpu_variant(TaskContext context)
{
  dense_to_csr_nnz_template<VariantKind::CPU>(context);
}

/*static*/ void DenseToCSR::cpu_variant(TaskContext context)
{
  dense_to_csr_template<VariantKind::CPU>(context);
}
