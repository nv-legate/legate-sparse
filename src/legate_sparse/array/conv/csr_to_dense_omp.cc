...
#include "legate_sparse/array/conv/csr_to_dense.h"
#include "legate_sparse/array/conv/csr_to_dense_template.inl"
...
/*static*/ void CSRToDense::omp_variant(TaskContext context)
{
  csr_to_dense_template<VariantKind::OMP>(context);
}
